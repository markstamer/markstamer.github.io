...
//extension Card {
//    static func workCard(title: String, image: String, imageLayout: WorkCardImagePlacement, description: String, keyFeaturesMarkdown: String, techBadges: [String]) -> Card {
//        Card {
//            Section {
//                let textGroup = Group {
//                    Text(title)
...
struct WorkCard: Component {
    ...
    init(title: String, image: String, imageLayout: WorkCardImagePlacement, description: String, keyFeaturesMarkdown: String, techBadges: [String]) {
        self.title = title
        self.image = image
        self.imageLayout = imageLayout
        self.description = description
        self.keyFeaturesMarkdown = keyFeaturesMarkdown
