...
struct Imprint: StaticPage {
    ...
    func body(context: PublishingContext) async -> [any BlockElement] {
        Group {
            Text("Imprint").font(.title1)

            Text("Information pursuant to § 5 TMG:").font(.title4)

            Text {
                Text("Dr.-Ing. Mark Stamer")
                Text("Himmelstraße 33")
                Text("22299 Hamburg")
                Text("Germany")
            }

            Text("Contact:").font(.title4)

            Group {
                Text("E-Mail: markstamer@gmail.com")
                Text("Website: markstamer.github.io")
            }

            Text("VAT ID:").font(.title4)

            Text("VAT identification number according to § 27 a Value Added Tax Act: DE354159226")

            Text("Disclaimer").font(.title4)

            Text("Liability for Content").font(.title5)
            ...
            Text("Liability for Links").font(.title5)
